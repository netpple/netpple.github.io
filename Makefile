...
.PHONY: preview-up preview-build preview-smoke preview-linkcheck preview-structure preview-ids preview-verify preview-down preview-recreate preview-info
...
preview-verify: preview-build preview-smoke preview-linkcheck preview-structure preview-ids
