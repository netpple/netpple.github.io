...
{% assign featured_series_container_url = "/docs/make-container-without-docker/" %}
{% assign featured_post_install = posts | where: "url", "/2023/k8s-1.26-install/" | first %}
{% assign featured_post_etcd = posts | where: "url", "/2022/etcd/" | first %}
      ...
      <div class="home-feature-grid">
        ...
        {% if featured_series_istio %}
          <article class="home-feature-card">
            ...
            <h2 class="home-feature-card__title"><a href="{{ site.baseurl }}{{ featured_series_istio_url }}">{{ featured_series_istio.title }}</a></h2>
        ...
        {% if featured_series_container %}
          <article class="home-feature-card">
            ...
            <h2 class="home-feature-card__title"><a href="{{ site.baseurl }}{{ featured_series_container_url }}">{{ featured_series_container.title }}</a></h2>
            ...
            <a class="home-feature-card__cta" href="{{ site.baseurl }}{{ featured_series_container_url }}">시리즈 보기 →</a>
          </article>
        {% endif %}
      </div>
    </div>
