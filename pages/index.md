...
<section class="home-hero">
  <div class="home-hero__content">
    ...
    <p class="home-hero__description">쿠버네티스, 컨테이너, 서비스 메시, 분산 시스템 운영 경험을 포스트와 시리즈로 정리한 기술 아카이브입니다.</p>
    <p class="home-hero__summary">처음 방문했다면 대표 시리즈 1개와 대표 포스트 1개만 먼저 훑어보면 사이트 성격과 흐름을 빠르게 파악할 수 있습니다.</p>
    <div class="home-hero__actions button-row">
      <a class="button button--primary" href="{{ site.baseurl }}/docs/">시리즈 허브 보기</a>
    </div>
    <p class="home-hero__subnav">Posts는 <a href="{{ site.baseurl }}/news/">최신 포스트 목록</a>에서 이어서 탐색할 수 있습니다.</p>
      ...
      <div class="home-feature-grid">
        {% if featured_post_install %}
          <article class="home-feature-card">
            ...
            <p class="home-feature-card__reason">사이트 전반의 실전 톤을 가장 빠르게 파악할 수 있는 대표 입문 포스트입니다.</p>
        ...
        {% if istio_series_entries.size > 0 %}
          <article class="home-feature-card">
            ...
            <p class="home-feature-card__reason">연속된 읽기 흐름이 필요한 방문자에게 가장 성격이 분명한 대표 시리즈입니다.</p>
