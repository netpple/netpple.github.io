...
{% assign querypie_docs = site.docs | where: "label", "쿼리파이 핸즈온" %}
{% assign series_entries = istio_docs | concat: docker_docs | concat: kube_docs | concat: ddd_docs | concat: querypie_docs %}
...
<section class="home-section">
  <div class="section-heading">
    <p class="section-heading__kicker">Series Tracks</p>
