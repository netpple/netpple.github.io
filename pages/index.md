...
<section class="home-hero">
  <div class="home-hero__content">
    ...
    <p class="home-hero__note">처음 방문했다면 대표 시리즈 1개와 대표 포스트 1개를 먼저 본 뒤 <a href="{{ site.baseurl }}/news/">Posts 목록</a>으로 이어가면 전체 흐름을 빠르게 파악할 수 있습니다.</p>
      ...
      <div class="home-feature-grid">
        {% if featured_post_install %}
          <article class="home-feature-card">
            ...
            <p class="home-feature-card__summary">실습 중심의 쿠버네티스 설치와 운영 환경 구성을 통해 사이트의 실전 톤을 가장 빠르게 파악할 수 있는 대표 입문 포스트입니다.</p>
        ...
        {% if istio_series_entries.size > 0 %}
          <article class="home-feature-card">
            ...
            <p class="home-feature-card__summary">트래픽 제어, 관측성, 보안, 트러블슈팅 흐름을 연속적으로 읽을 수 있는 대표 시리즈입니다.</p>
