...
<section class="page-section">
  <div class="entry-card">
    ...
    <h2 class="entry-card__title">Cloud Native와 대규모 분산 시스템을 설계하고 운영합니다.</h2>
    <p class="entry-card__excerpt">
      검색/플랫폼 영역에서 클라우드 전환, 운영 자동화, 보안 강화를 중심으로 개발과 조직 리딩을 수행해왔습니다.
      현재는 QueryPie에서 CTO로 일하고 있습니다.
    </p>
  ...
  <div class="entry-grid">
    ...
    <article class="entry-card entry-card--news">
      ...
      <ul class="entry-card__list">
        ...
        <li><a href="{{ site.baseurl }}/docs/deepdive-into-kubernetes/" target="_blank" rel="noreferrer noopener">쿠버네티스 딥다이브 시리즈</a></li>
