...
assert_route_contains "${sample_doc}" 'article-header__eyebrow\">Series<' "Series landing eyebrow"
assert_route_not_contains "${sample_doc}" 'article-header__eyebrow\">Series entry<' "Series landing not mislabeled as Series entry"
assert_route_contains "${sample_doc}" 'property="og:type" content="website"' "Series landing og:type"
assert_route_not_contains "${sample_doc}" 'property="og:type" content="article"' "Series landing not using article og:type"
assert_route_not_contains "${sample_doc}" 'rel="canonical" href="[^"]*/index"' "Series landing canonical without /index"
assert_route_not_contains "${sample_doc}" 'property="og:url" content="[^"]*/index"' "Series landing og:url without /index"
