...
assert_route_contains "${sample_doc}" 'Documentation Hub' "docs detail hub backlink"
assert_route_contains "${sample_doc_detail}" 'Documentation Hub' "docs detail hub backlink"
assert_route_contains "${sample_doc_hands_on}" 'Documentation Hub' "docs detail hub backlink"
assert_route_not_contains "${sample_doc}" 'All News' "news-only backlink in docs detail"
