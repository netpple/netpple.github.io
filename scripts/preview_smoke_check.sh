...
sample_announcement="/announcements/blog-renewal/"
...
assert_route_contains "${sample_announcement}" '문서 허브 보기|About Sam 보기' "announcement follow-up links"
...
assert_article_content_heading_hierarchy "${sample_announcement}"
