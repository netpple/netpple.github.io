...
- Runtime nav consistency check (`desktop/mobile`, GNB height/alignment/hover/active + toggle visibility/aria-label transitions, keyboard toggle Enter/Space, resize transition, and toggle/Escape/outside-click close behavior)
