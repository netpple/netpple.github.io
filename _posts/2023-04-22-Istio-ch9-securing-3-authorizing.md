...
![webapp 트래픽 유입](/assets/img/Istio-ch9-securing-3-authorizing/sleep_to_webapp_200_permissive.png)
...
200
```
![webapp ALLOW 정책](/assets/img/Istio-ch9-securing-3-authorizing/sleep_to_webapp_ALLOW.png)
