---
title: 2편. 쿠버네티스 라이브 디버깅 환경
version: v1.0
description: 쿠버네티스 메인 컴포넌트들을 직접 빌드하고 디버깅 할 수 있는 환경을 구성해 봅니다. 
date: 2022-03-23 10:00:00 +09:00
label: 쿠버네티스 딥다이브
comments: true
image: https://netpple.github.io/docs/assets/img/deepdive-into-kubernetes-2-live-debugging.png
histories:
- date: 2022-03-23 10:00:00 +09:00
  description: 최초 등록
---
