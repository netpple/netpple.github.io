...
<div class="responsive-wrap">
  <iframe src="https://docs.google.com/presentation/d/e/2PACX-1vSU7CRFtNv8nFEUPwfow0HfbrMqPNmYJ7I95z_GHf8_fonz-wvsVdL4vrfNdFkfNbYhxh9hAg4tQbuS/embed?start=false&loop=false&delayms=3000" title="{{ page.title | escape }}" loading="lazy" frameborder="0" width="100%" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
</div>
