...
이번 리뉴얼에서는 첫 화면과 콘텐츠 진입 경로를 더 짧고 명확하게 정리했습니다.
...
- [최신 글 보기]({{ site.baseurl }}/news/)
- [문서 허브 보기]({{ site.baseurl }}/docs/)
- [About Sam 보기]({{ site.baseurl }}/about/)

앞으로도 사이트 구조 변경, 새 시리즈 추가, 주요 발표와 운영 공지는 이 공지 흐름을 통해 같은 방식으로 안내합니다.
